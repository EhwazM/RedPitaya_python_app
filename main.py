...
p = bk_figure(title="Signal", sizing_mode='stretch_both', x_axis_label='Time', y_axis_label='Voltage (V)', y_range=Range1d(start=-1, end=1), x_range=Range1d(start=-30, end=30)) # type: ignore
